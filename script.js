...
document.addEventListener('DOMContentLoaded', function () {
  ...
  async function setupLanguageDropdown(headerContainer) {
    ...
    function applyLanguage(lang) {
      ...
      if (!img) return;
      const map = {
        'be-nl':'flags/be.png','be-fr':'flags/be.png','be-en':'flags/be.png', 'be-de':'flags/be.png',
...
document.addEventListener('DOMContentLoaded', () => {
    const privatePages = [
        ...
        'submit_returns.php','update_profile.php','delete_account.php','processing_retours.html',
        'staff_pages.html','create_own_voucher.html','create_own_voucher.php','create_own_voucher_invoice.php'
    ];
    ...
    const guestPages = [
        ...
        'create_own_voucher.html','create_own_voucher.php','create_own_voucher_invoice.php'
    ];
